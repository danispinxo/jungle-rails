...
RSpec.describe Order, type: :model do
  describe 'After creation' do
    before :each do
      ...
      @product1 = Product.create!(name: 'Tall Plant', description: 'A fairly tall plant that is perfect for tall people.', image: 'plante_image.jpg', price_cents: 3999, quantity: 30, category_id: 1)
